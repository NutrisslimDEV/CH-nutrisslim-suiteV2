...
// Get product short description based on the cookie value
switch ($user_country) {
    case 'FR':
        $short_description = get_post_meta($pid, '_product_short_description_fr', true);
        break;
    case 'IT':
        $short_description = get_post_meta($pid, '_product_short_description_it', true);
        break;
    case 'DE':
    default:
        $short_description = get_post_meta($pid, '_product_short_description_de', true);
        break;
}


// Fallback to WooCommerce default short description if none is set
if (empty($short_description) && $_product instanceof WC_Product) {
...
$short_description = wp_trim_words(wp_strip_all_tags($short_description), 15, '...');
            ...
            echo '<img decoding="async" src="/wp-content/uploads/2024/04/Home-Ikone-NOVO_cart.svg" alt="Add to cart" style="vertical-align: middle; margin-right: 8px;">' . __('Add to cart', 'nutrisslim-suiteV2') . '</a>';
            echo '</div>'; // col-12
